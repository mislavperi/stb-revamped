...
var operationRolesBearerAuth = map[string][]string{
	CreateStbUserOperation:       []string{},
	CreateTimeEntryOperation:     []string{},
	DeleteStbUserByUUIDOperation: []string{},
	GetStbUserByUUIDOperation:    []string{},
	GetStbUsersOperation:         []string{},
	GetTimeEntriesOperation:      []string{},
	RemoveTimeEntryOperation:     []string{},
	UpdateStbUserByUUIDOperation: []string{},
